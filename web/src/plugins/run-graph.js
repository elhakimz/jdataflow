( function(Dataflow) {
    ...
    var $formtemplate=$(
            ...
            '<button class="btn btn-default" id="run-with-param" style="width: 150px">Run with Parameters</button></div>'+
            '<div  class="tab-pane" id="tabs-2">' +
            '<button id="clearlog" class="btn btn-default">Clear</button>'+
            '<textarea id="message" class="form-control" rows="8"></textarea></div>' +
            +'</div>'
