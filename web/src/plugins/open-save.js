...
( function(Dataflow) {
    ...
    OpenSave.initialize = function(dataflow) {
     ...
     var $form = $(
        ...
        $form.find('#btnNew').click(function(){OpenSave.doNew(dataflow)});
        $form.find('#btnSave').click(function(){OpenSave.doSave(dataflow)});
        $form.find('#btnOpen').click(function(){OpenSave.doOpen(dataflow)});
    ...
    OpenSave.doNew=function(dataflow){
        ...
        dialog.html(templ);
        dlg.modal('show');
        var btnAction=dlg.find('#dlg-btn-action');
