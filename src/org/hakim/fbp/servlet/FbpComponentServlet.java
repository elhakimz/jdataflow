...
import org.hakim.fbp.common.FbpCompJsBuilder;
 ...
 *         Date: 9/18/14.
 */
public class FbpComponentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String out="";
        try {
            out=FbpCompJsBuilder.getInstance().buildFbpCompToJs(Class.forName(className));
